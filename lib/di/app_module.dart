...
import 'package:money_expense_dot/feature/add_edit/data/repository/category_repository.dart';
...
abstract class AppModule {
  static Future<void> inject() async {
    ...
    injector.registerFactory<ICategoryRepository>(
      () => CategoryRepository(injector.get<AppDatabase>()),
    );
